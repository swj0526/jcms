...
public class Function {
     ...
     * 账号管理-账号管理
     */
    public static final int FUNC1 = 100;
    ...
    public static final int FUNC2 = 200;
     ...
     * 信息管理-试课学生管理
     */
    public static final int FUNC_LISTENING = 205;
    public static final String FUNC_LISTENING_NAME = "试课学生管理";
    /**
     * 信息管理-来源渠道管理
     */
    public static final int FUNC_CHANNEL = 206;
    public static final String FUNC_CHANNEL_NAME = "来源渠道管理";
    /**
     * 信息管理-渠道统计
     */
    public static final int FUNC_RECRUIT_DATA = 207;
    public static final String FUNC_RECRUIT_DATA_NAME = "渠道统计";
    /**
     * 流程管理-流程管理
     */
    public static final int FUNC3 = 300;
     ...
     * 审批管理
     */
    public static final int FUNC4 = 400;
     ...
     * 发文管理
     */
    public static final int FUNC6 = 600;
     ...
     * 发文管理-公告列表
     */
    public static final int FUNC_NOTICE_LIST = 602;
    public static final String FUNC_NOTICE_LIST_NAME = "公告列表";
    /**
     * 发文管理-文章列表
     */
    public static final int FUNC_ARTICLE_LIST = 603;
    public static final String FUNC_ARTICLE_LIST_NAME = "文章列表";
    /**
     * 提醒管理
     */
    public static final int FUNC7 = 700;
     ...
     * 作业管理
     */
    public static final int FUNC8 = 800;
     ...
     * 积分管理
     */
    public static final int FUNC9 = 900;
