...
<div id="add" style="display: none">
    <div style="margin: 10px 10px 10px 10px">
        <form class="layui-form layui-form-pane" lay-filter="dataForm" id="dataFrm" action="" >
            <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input name="phone" class="layui-input" type="tel" autocomplete="off" lay-verify="required|phone" id="phone">
                    </div>
                </div>
                <div class="layui-form-item">
                    <span style="color: red;display: inline-block;height: 38px;line-height: 38px;">*</span>
        ...
        <form class="layui-form layui-form-pane" lay-filter="dataForm1" id="dataFrm">
            <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    ...
                    <label class="layui-form-label">手机号</label>
                    <div class="layui-input-inline">
                        <input name="phone" class="layui-input" type="tel" autocomplete="off" lay-verify="required|phone" id="phone1">
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="name" autocomplete="off" class="layui-input"
                                   placeholder="例：1990/张三" id="name2">
                        </div>
                    </div>
                    <div class="layui-inline">
